...
public class BonusManager {
    ...
    public void giveBonus(int paddle, int ball) {
           ...
           int Bonus = PaddleWars.Ball[ball].getBonusType();
    ...
    private void increasePaddleX(int paddle) {
           ...
           //test that it doesn't equal 3 first, because that is the max size limit.
           int PaddleSizeX = PaddleWars.Paddle[paddle].getpSizeX();

           if (PaddleSizeX != 3) {
              //since it isn't at the max size, we then increase it.
               PaddleWars.Paddle[paddle].increasepSizeX(1);
           }
    ...
    private void increaseBallSpeed() {
           ...
           //test that it doesn't equal 3 first, because that is the max size limit.
           int BallSpeed = PaddleWars.Ball[0].getSpeed();

           if (BallSpeed != 3) {
              //since it isn't at the max size, we then increase it.
               PaddleWars.Ball[0].increaseSpeed(1);
           }
    ...
    private void increaseBallSize() {
           ...
           //test that it doesn't equal 3 first, because that is the max size limit.
           int BallSize = PaddleWars.Ball[0].getBallSize();

           if (BallSize != 3) {
              //since it isn't at the max size, we then increase it.
               PaddleWars.Ball[0].increaseSize(1);
           }
