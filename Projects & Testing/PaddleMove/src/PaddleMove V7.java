...
public class PaddleWars2 extends Applet /*sets up this class to be a applet*/ implements Runnable /*this sets up the applet to use threads*/ {
    ...
    public void BPRIntercept() {
        ...
        int BPD_2B = (int)Math.sqrt(Math.pow(BxC-P2xRC,2) + Math.pow(ByC-P2yRCT,2));
    ...
    public void BPRgetIntercepts() {
        ...
        if (Bx>200) {
            Xpaddle = P2xRC;
            Ypaddle = 
        int XIntercept = (((BxC)+(2*Xpaddle))/3)-35;
