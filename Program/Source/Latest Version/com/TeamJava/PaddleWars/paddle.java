...
public class paddle extends JPanel {
	...
	*     paddles animation.
	* @param explosion The images for the eplosion animation.
	...
	* @param color The colour of the paddle.
       ...
       public paddle(int paddleX, int paddleY, int pXsize,
                    int pYsize, Image[] image, Image[] explosion,
       ...
       public void paint(Graphics g) {
              ...
              if (expFlag == true) {
                  ...
                  g2.drawImage(Explosion[ExpFrame],(int)expSpot.x-15,(int)expSpot.y-15,this);
              }
              ...
              for (int i = 0; i<BallLength; i++) {
                  ...
                  BallIntercept[i].TestIntercept(paddle , size, pSizeY, pSizeX, ball, ballR, ballS, WhichPaddle, paddleHit[i]);
              ...
              for (int i = 0; i<MissileLength; i++) {
                  ...
                  MissileIntercept[0][i].TestIntercept(paddle , size, pSizeY, pSizeX, Missiles1Center, Missiles1Radius, Missiles1Size, WhichPaddle, paddleHit[2]);
                  ...
                  MissileIntercept[1][i].TestIntercept(paddle , size, pSizeY, pSizeX, Missiles2Center, Missiles2Radius, Missiles2Size, WhichPaddle, paddleHit[2]);
