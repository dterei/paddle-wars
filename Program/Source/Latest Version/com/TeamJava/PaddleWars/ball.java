...
public class ball extends JPanel {
       ...
       * @param ball The images the animation method will use to  
       *     display the ball.
       ...
       * @param arrayN 
       */
      public ball(int ballX,int ballY, int ballR, Color[] color, int bonusType, int screenX, int screenY, AudioClip wallhit) {
      ...
      private void changeBallX() {
             ...
             if (center.x <= 0 && center.x> -50) {
                    ...
                    if (BallType == 2 && MissileExploded == 0) { resetMissile(); }
             }
